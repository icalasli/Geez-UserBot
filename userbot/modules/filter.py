...
@register(outgoing=True, pattern=r"^pltr (.*)")
...
@register(outgoing=True, pattern=r"^spltr (.*)")
...
@register(outgoing=True, pattern="^pltrs$")
...
CMD_HELP.update({
    ...
    \n\n`pltr` <keyword> <balasan> atau balas ke pesan ketik .filter <keyword>\
